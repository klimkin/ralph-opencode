...
1. Update the story's `passes` field to `true` in `./tasks/prd.json`
2. Append your progress to `./tasks/progress.txt`
3. End your response

The external loop will check `./tasks/prd.json` to determine if all stories are complete.
